...
class SlitSliderWidget extends CWidget
{
    ...
    public function registerAssets()
    {
        ...
        // JS files
        $js = Yii::app()->assetManager->publish(Yii::getPathOfAlias('SlitAssets') . '/js', true, -1, false); // set last param to `true` for development
        ...
        // CSS files
        $css = Yii::app()->assetManager->publish(Yii::getPathOfAlias('SlitAssets') . '/css', true, -1, false); // set last param to `true` for development
